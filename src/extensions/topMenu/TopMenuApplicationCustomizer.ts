...
export default class TopMenuApplicationCustomizer extends BaseApplicationCustomizer<
    ITopMenuApplicationCustomizerProperties
> {
    ...
    private _renderPlaceHolders(): void {
        ...
        if (!this._topPlaceholder) {
            ...
            if (this.properties) {
                ...
                if (!termSetId) {
                    termSetId = "(Top property was not defined.)";
                }
